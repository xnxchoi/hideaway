    ...
    var data = {
        "resource": {
            ...
            "tags": [{
                ...
                "priority": 13,
                "vtp_includeConditions": ["list", "kauth\\.kakao\\.com", "accounts\\.kakao\\.com", "logins\\.daum\\.net", "online\\-pay\\.kakao\\.com", "rsmpay\\.kcp\\.co\\.kr", "pg\\-web\\.kakao\\.com", "longblack\\.co", "payco\\.com"],
                "tag_id": 116
            }, {
                ...
                "priority": 12,
                "vtp_instanceDestinationId": "G-JW3YGBLHDY",
                "tag_id": 130
            }, {
                ...
                "priority": 2,
                "vtp_conversionRules": ["list", ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"purchase\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"signup_pageview\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"today_read\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"note_pageview\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"]],
                "vtp_instanceDestinationId": "G-JW3YGBLHDY",
                "tag_id": 120
            }, {
...
*/
 ...
 jQuery (c) 2005, 2012 jQuery Foundation, Inc. jquery.org/license. */
    var ld = /\[object (Boolean|Number|String|Function|Array|Date|RegExp)\]/
      ...
      , pd = function(a, b) {
        var c = b || ("array" == md(a) ? [] : {}), d;
        for (d in a)
            if (nd(a, d)) {
                var e = a[d];
                "array" == md(e) ? ("array" != md(c[d]) && (c[d] = []),
                c[d] = pd(e, c[d])) : od(e) ? (od(c[d]) || (c[d] = {}),
                c[d] = pd(e, c[d])) : c[d] = e
            }
        return c
    };
    ...
    var ud = {
        ...
        reverse: function() {
            for (var a = sd(this), b = a.length - 1, c = 0; 0 <= b; b--,
            c++)
    ...
    var Ud = function(a, b, c, d) {
      ...
      , Wd = function(a, b) {
        ...
        if (a instanceof jb || a instanceof ya || a instanceof fb)
            c = a.get(b);
    ...
    function Ge(a) {
        if (a instanceof ta || a instanceof fb || a instanceof ya || a instanceof jb || a instanceof id || null === a || void 0 === a || "string" === typeof a || "number" === typeof a || "boolean" === typeof a)
            return a
    }
    ;function Ie(a) {
        switch (a) {
    ...
    var jf;
    var kf = [], lf = [], mf = [], nf = [], of = [], pf = {}, qf, rf, tf = function() {
        var a = sf;
        rf = rf || a
        ...
        var e = pf[c], f = b && 2 === b.type && d.Hh && e && -1 !== wf.indexOf(c), g = {}, k = {}, m;
        for (m in a)
        ...
        if (Ha(a)) {
            ...
            case "escape":
                d = zf(a[1], b, c);
                if (rf && Ha(a[1]) && "macro" === a[1][0] && rf.Kl(a))
                    return rf.jm(d);
                d = String(d);
        ...
        Qh(a, function(c) {
            for (var d = ["tv.1"], e = 0, f = 0; f < c.length; ++f) {
                var g = c[f].name
                  ...
                  , m = c[f].index
                  , n = Nh[g];
                n && k && (-1 === Gh.indexOf(g) || /^e\d+$/.test(k) || Lh.test(k) || Jh.test(k)) && (void 0 !== m && (n += m),
                d.push(n + "." + k),
                e++)
            }
    ...
    ii.fe = Number("0") || 0;
    ii.ka = "dataLayer";
    ii.Uj = "ChEI8POGpwYQwKfQoLnu2YWNARIlABhc5uesxd5h/Bjkm4HjnDuZIcuOLqdV+46yTLWU4UsLr0zTcxoCM9c\x3d";
    var li = {
        __cl: 1,
        __ecl: 1,
        __ehl: 1,
    ...
    P[75] = !0;
    a: {
        for (var aj = void 0, bj = void 0, cj = 0; aj === bj; )
            if (aj = Math.floor(2 * Math.random()),
            bj = Math.floor(2 * Math.random()),
            cj++,
            20 < cj)
                break a;
        aj ? P[78] = !0 : P[79] = !0
    ...
    var ej;
    try {
        ej = JSON.parse(tb("eyIwIjoiS1IiLCIxIjoiIiwiMiI6ZmFsc2UsIjMiOiJnb29nbGUuY28ua3IiLCI0IjoiIiwiNSI6dHJ1ZSwiNiI6ZmFsc2UsIjciOiJhZF9zdG9yYWdlfGFuYWx5dGljc19zdG9yYWdlfGFkX3VzZXJfZGF0YXxhZF9wZXJzb25hbGl6YXRpb24ifQ"))
    } catch (a) {
        M(123),
        dj(2),
        ej = {}
        ...
        if (yj(p, n, e, f)) {
            ...
            q && z.setTimeout(function() {
                if (k[b] === r && r.quiet) {
                    ...
                    if (hf(4))
                        for (var u in rj)
                            rj.hasOwnProperty(u) && rj[u] === b && t.push(u);
    ...
    aa.update = function(a, b) {
        ...
        if (void 0 != b) {
            ...
            if (hf(4))
                for (var k in rj)
                    rj.hasOwnProperty(k) && rj[k] === a && g.push(k);
            if (e.quiet) {
                e.quiet = !1;
    ...
    ;var Nj = [N.g.I, N.g.R, N.g.O, N.g.Fb]
      ...
      , Sj = function(a) {
        ...
        ++d.ad)
            a.hasOwnProperty(N.g.Vf) && l(hi, function(e) {
                return function(f) {
      ...
      , mk = function() {
        ...
        if (a) {
            ...
            if (b.siloed) {
                ...
                g++)
                    f.ne = b.siloed[g],
                    !ck && Ja(f.ne.isDestination ? e : d, function(k) {
                        return function(m) {
                            return m === k.ne.ctid
                        }
                    }(f)) ? ck = !0 : c.push(f.ne);
    ...
    function nk() {
        ...
        if (a.pending) {
            ...
            k++)
                g.gd = a.pending[k],
                Ja(g.gd.target.isDestination ? f : e, function(m) {
                    return function(n) {
            ...
            if ("array" === d) {
                ...
                for (var f in c)
                    if (!b.hasOwnProperty(f))
                        return !0;
                for (var g in b)
                    if (!c.hasOwnProperty(g) || Rk(a, b[g], c[g]))
                        return !0
            }
        } catch (k) {
            M(72)
    ...
    var ol = function(a, b, c, d) {
      ...
      , rl = /[?&]($|#)/
      , sl = function(a, b, c) {
        for (var d, e = a.search(pl), f = 0, g, k = []; 0 <= (g = ol(a, f, b, e)); )
    ...
    var Al = function(a) {
      ...
      , zl = function(a, b) {
        ...
        if (c.fetch) {
            ...
            yl(c, a, void 0 === b ? !1 : b, void 0 === d ? !1 : d)
    };
    var Bl = function() {};
    var Cl = function(a) {
    ...
    var Il = function(a, b, c) {
        ...
        if (0 === k)
            ...
            m = 1 === k ? a.purpose && a.vendor ? Hl(a.purpose.legitimateInterests, b) && Hl(a.vendor.legitimateInterests, void 0 === d ? "755" : d) : !0 : !0;
        return m
    }
      , Hl = function(a, b) {
        return !(!a || !a[b])
    ...
    function Rl(a) {
        var b = {}
          , c = (b[N.g.I] = a.Xb["1"] ? "granted" : "denied",
        b);
        Q(90) && (c[N.g.Fb] = a.Xb["3"] && a.Xb["4"] ? "granted" : "denied",
        "number" === typeof a.tcfPolicyVersion && 4 <= a.tcfPolicyVersion && (c[N.g.O] = a.Xb["1"] && a.Xb["7"] ? "granted" : "denied"));
        Qj(c, {
            eventId: 0
        }, {
    ...
    var fm = function(a) {
        ...
        for (var n = "G1", p = 0; p < Wl.length; p++)
            switch (Dj(Wl[p])) {
            case 3:
                n += "1";
                break;
      ...
      , gm = function() {
        ...
        if (b && d)
            for (var f in sj)
                sj.hasOwnProperty(f) && sj[f].enabled && c.hasOwnProperty(f) && c[f].enabled && e.push(f);
        else {
            var g = b ? sj : c, k;
            for (k in g)
    ...
    var Tm = {
      ...
      , Um = function(a) {
        ...
        var g = c.hn, k = 4 + d + (g ? "" + Gg(2, 1) + "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-_"[g] : ""), m, n = c.xm;
    ...
    ;var gn, hn = function() {
        ...
        a && (b.h[N.g.Qd] = a.architecture,
        b.h[N.g.Rd] = a.bitness,
        a.fullVersionList && (b.h[N.g.Sd] = a.fullVersionList.map(function(c) {
            return encodeURIComponent(c.brand || "") + ";" + encodeURIComponent(c.version || "")
        }).join("|")),
        b.h[N.g.Td] = a.mobile ? "1" : "0",
        b.h[N.g.Ud] = a.model,
        b.h[N.g.Vd] = a.platform,
        b.h[N.g.Wd] = a.platformVersion,
        b.h[N.g.Xd] = a.wow64 ? "1" : "0")
    };
    var mn = /:[0-9]+$/
      ...
      , rn = function(a, b, c, d, e) {
        ...
        if ("protocol" === b || "port" === b)
            a.protocol = pn(a.protocol) || pn(z.location.protocol);
    ...
    function Jn(a, b) {
        var c = [zc.userAgent, (new Date).getTimezoneOffset(), zc.userLanguage || zc.language, Math.floor(Ua() / 60 / 1E3) - (void 0 === b ? 0 : b), a].join("*"), d;
        if (!(d = xn)) {
    ...
    var Vn = function(a, b, c, d) {
      ...
      , Xn = function() {
        ...
        var k = a.replace(Gn, ""), m = e.replace(Gn, ""), n;
        if (!(n = k === m)) {
            var p = "." + m;
            ...
            for (var d = xo(b.prefix), e = 0; e < a.length; ++e) {
                ...
                if (void 0 !== po[f]) {
                    var g = Co(f, d)
                      , k = c[g];
                    if (k) {
                        var m = Math.min(Do(k), Ua()), n;
                        b: {
                            var p = m;
                            if (mm(z))
                                for (var q = pm(g, H.cookie, void 0, "ad_storage"), r = 0; r < q.length; ++r)
                                    if (Do(q[r]) > p) {
                                        n = !0;
                                        break b
                                    }
        ...
        if (mm(z)) {
            ...
            ro(function() {
                l(d, function(f, g) {
                    ...
                    if (k.length) {
                        var m = k[0], n = Do(m), p = 0 !== Fo(m.split(".")).length ? m.split(".").slice(3) : [], q = {}, r;
    ...
    ;var qp = function(a) {
        ...
        if (!a.isAborted && b)
            for (var c = op(a), d = 0; d < b.length; ++d) {
                try {
                    b[d](c)
                } catch (e) {
                    a.isAborted = !0
    ...
    function Lp(a) {
        var b = U(a.s, N.g.wb)
          , c = U(a.s, N.g.Kb);
        b && !c ? (a.eventName !== N.g.oa && a.eventName !== N.g.pd && M(131),
    ...
    var Rp = []
      ...
      , Wp = function(a) {
        Sp ? 0 <= a && a < Rp.length && Rp[a] && (Rp[a].disconnect(),
        Rp[a] = void 0) : z.clearInterval(a)
    };
        ...
        for (var c = b.querySelectorAll("*"), d = 0; d < c.length && 1E4 > d; d++) {
            ...
            if (!(0 <= gq.indexOf(e.tagName.toUpperCase())) && e.children instanceof HTMLCollection) {
                for (var f = !1, g = 0; g < e.childElementCount && 1E4 > g; g++)
                    if (!(0 <= hq.indexOf(e.children[g].tagName.toUpperCase()))) {
                        f = !0;
                        break
                    }
    ...
    ;var Lq = !1;
    function Mq() {
        if (Kq("join-ad-interest-group") && Ea(zc.joinAdInterestGroup))
            return !0;
        Lq || (vl(''),
        Lq = !0);
    ...
    Ct))
      ...
      , Gt = function(a, b, c) {
        if (Ck && "config" === a && !(1 < Uo(b).N.length)) {
            ...
            for (k in d) {
                var m = Ft(d[k], f);
                m.length && (Et && console.log(m),
                g.push(k))
            }
            g.length && (g.length && Ck && zt.push(b + "*" + g.join(".")),
            vb("TAGGING", Bt[H.readyState] || 14));
            d[b] = f
        }
    };
    function Ht(a, b) {
    ...
    var Rt = function(a, b) {
      ...
      , St = function(a, b, c, d) {
        if (mi.hasOwnProperty(b) || "__zone" === b)
            return -1;
        var e = {};
        od(d) && (e = pd(d, e));
        e.id = c;
    ...
    function ou(a) {
        var b = a.eventId, c = a.Zb, d = mu[b] || {}, e = [], f;
        for (f in d)
    ...
    function Cv(a) {
        for (var b = [], c = 0; c < a.length; c++)
            if (a[c]) {
                ...
                if (li[d] || void 0 !== nf[c][Le.Gk] || Ci[d] || ct(d, 2))
                    b[c] = !0
            }
        return b
    }
    function Dv(a, b) {
        if (!b)
            return b;
        for (var c = 0; c < a.length; c++)
            if (a[c] && nf[c] && !mi[String(nf[c][Le.ya])])
                return !0;
        return !1
    }
    var Fv = {};
    function Gv(a, b, c) {
        Ck && void 0 !== a && (Fv[a] = Fv[a] || [],
        Fv[a].push(c + b),
        Mk(a))
    }
    function Hv(a) {
      ...
      , Sv = function(a, b, c, d) {
        if (d.h) {
            ...
            if (f) {
                ...
                try {
                    Gv(d.messageContext.eventId, r, "1"),
                    Gt(d.type, d.h.id, u),
                    f(d.h.id, b, d.C, u)
                } catch (v) {
    ...
    Rv.prototype.push = function(a, b, c, d) {
        void 0 !== c && (1 === Mv(this, c).status && (Mv(this, c).status = 2,
        this.push("require", [{}], c, {})),
        Mv(this, c).C && (d.deferrable = !1));
    ...
    Rv.prototype.flush = function(a) {
        for (var b = this, c = [], d = !1, e = {}; this.h.length; ) {
            ...
            if (f.messageContext.deferrable)
                !g || Mv(this, g).C ? (f.messageContext.deferrable = !1,
                ...
                case "config":
                    ...
                    k.C = !0;
                    n ? pd(e.Tb, k.D) : (pd(e.Tb, k.K[g.id]),
                    M(70));
                    d = !0;
                    break;
                case "event":
    ...
    var Tv = function(a, b) {
        if ("require" !== b.type)
            if (b.h)
                for (var c = Mv(a, b.h).B[b.type] || [], d = 0; d < c.length; d++)
                    c[d]();
            else
                for (var e in a.B)
    ...
    var gw = {
        config: function(a, b) {
            ...
            if (!(2 > a.length) && h(a[1])) {
                var e = {};
                if (2 < a.length) {
                    if (void 0 != a[2] && !od(a[2]) || 3 < a.length)
                        return;
                    e = a[2]
                }
        ...
        event: function(a, b) {
            ...
            if (!(2 > a.length) && h(c)) {
                var d;
                if (2 < a.length) {
                    if (!od(a[2]) && void 0 != a[2] || 3 < a.length)
                        return;
                    d = a[2]
                }
                var e = d
                ...
                f);
                e && (g.eventModel = pd(e),
                e[N.g.Oc] && (g.eventCallback = e[N.g.Oc]),
                e[N.g.Dd] && (g.eventTimeout = e[N.g.Dd]));
                var k = bw(a, b)
                  , m = k.eventId
                  , n = k.priorityId;
                ...
                if (h(r) || Ha(r)) {
                    ...
                    var u = Wv(t, b.isGtmEvent)
                      ...
                      , w = u.Zl;
                    if (w.length)
                        for (var x = fw(q), y = 0; y < w.length; y++) {
        ...
        set: function(a, b) {
            var c;
            2 == a.length && od(a[1]) ? c = pd(a[1]) : 3 == a.length && h(a[1]) && (c = {},
        ...
        for (var a = !1, b; !Kw && (b = Rw()); ) {
            ...
            if (null == d)
                ...
                try {
                    ...
                    if ("number" === typeof u) {
                        for (var v = Gw[String(u)] || [], w = 0; w < v.length; w++)
                            Iw.push(Tw(v[w]));
                        v.length && Iw.sort(Lw);
                        delete Gw[String(u)];
                        u > Fw && (Fw = u)
    ...
    var Hx = !!z.MutationObserver
      ...
      , Kx = function(a) {
        if (Ix)
            for (var b = 0; b < Ix.length; b++)
                Ix[b] === a && Ix.splice(b, 1)
    };
    ...
    ;function Ly() {
        var a = ["&cv=6", "&rv=" + ii.Pg, "&tc=" + nf.filter(function(b) {
            return b
        }).length];
    ...
    var PA = function(a, b) {
      ...
      , QA = function(a, b) {
        for (var c = rn(tn((b.attributes && b.attributes.formaction ? b.formAction : "") || b.action || Sc(b, "href") || b.src || b.code || b.codebase || ""), "host"), d = 0; d < a.length; d++)
            try {
        ...
        var a = 0
          , b = function(c) {
            ...
            if (d && 3 !== c.which && !(c.nh || c.timeStamp && c.timeStamp === a)) {
                ...
                var e = c.defaultPrevented || !1 === c.returnValue, f = Ax("aelc", e ? "nv.mwt" : "mwt", 0), g;
    ...
    var VA = function(a) {
      ...
      , ZA = function() {
        ...
        var c = 0
          ...
          , e = function() {
            ...
            XA(),
            Ax("sdl", "init", !1) && !YA() && (Lc(z, "scroll", f),
            Lc(z, "resize", f),
            yx("sdl", "init", !1)));
            d = !1
        }
      ...
      , $A = function(a, b, c, d) {
        ...
        for (g in e)
            ...
            f.kd = g,
            e.hasOwnProperty(f.kd)) {
                var k = Number(f.kd);
                if (!(a < k)) {
                    var m = {};
                    Mw((m.event = "gtm.scrollDepth",
    ...
    var jc = da(["data-gtm-yt-inspected-"]), dB = ["www.youtube.com", "www.youtube-nocookie.com"], eB, fB = !1;
    var gB = function(a, b, c) {
        ...
        function r() {
            if (u.length && 0 !== y) {
                ...
                c = function() {
                    d = 0;
                    c = p;
                    0 < u.length && u[0].Ba === E.Ba && (u.shift(),
                    Mw(t.createEvent("progress", E.Je, E.Le)));
                    r()
                }
                ;
      ...
      , kB = function(a, b) {
        if (!a.getAttribute("data-gtm-yt-inspected-" + b.kb) && (ic(a, "data-gtm-yt-inspected-" + b.kb),
        mB(a, b.te))) {
            a.id || (a.id = nB());
            var c = z.YT
              , d = c.get(a.id);
            ...
            for (g in e)
                ...
                f.Ee = g,
                e.hasOwnProperty(f.Ee) && d.addEventListener(f.Ee, function(k) {
                    return function(m) {
      ...
      , mB = function(a, b) {
        ...
        if (oB(c, "embed/")) {
            ...
            if (b) {
                var d;
                var e = -1 !== c.indexOf("?") ? "&" : "?";
                -1 < c.indexOf("origin=") ? d = c + e + "enablejsapi=1" : (eB || (eB = H.location.protocol + "//" + H.location.hostname,
                H.location.port && (eB += ":" + H.location.port)),
                d = c + e + "enablejsapi=1&origin=" + encodeURIComponent(eB));
                var f;
                f = Eb(d);
                a.src = Cb(f).toString();
                return !0
    ...
    function pB(a, b) {
        ...
        J(function() {
            for (var t = H.getElementsByTagName("script"), u = t.length, v = 0; v < u; v++) {
                ...
                if (oB(w, "iframe_api") || oB(w, "player_api"))
                    return b
            }
            for (var x = H.getElementsByTagName("iframe"), y = x.length, A = 0; A < y; A++)
                if (!fB && mB(x[A], n.te))
                    return Gc("https://www.youtube.com/iframe_api"),
                    fB = !0,
                    b
        });
        return b
    ...
    function TC() {
        ...
        a.set("containerId", 'G-JW3YGBLHDY'),
        a.set("version", '6'),
        a.set("environmentName", ''),
        a.set("debugMode", Xf),
        a.set("previewMode", Zf),
        a.set("environmentMode", Yf),
        Q(96) && a.set("firstPartyServing", ri || ti),
        a.sc();
        return a
    }
    ...
    var AD = function(a, b, c) {
      ...
      , ED = function(a, b) {
        var c = a.h[N.g.ab];
        if (U(a.s, N.g.wb) && U(a.s, N.g.Kb) || b && c === b)
            return c;
        if (c) {
            c = "" + c;
            if (!DD(c, a))
    ...
    var HD = function(a, b, c) {
        ...
        if (!d)
            return b;
        var e, f = Pa(null != (e = U(c.s, N.g.Tc)) ? e : 30);
    ...
    var ND = function(a) {
      ...
      , RD = function(a) {
        var b = ND(a) || {}
          ...
          , e = ID(a, c)
          , f = {};
        Yn(b[N.g.oc], !!b[N.g.U]) && (f = PD(a, d, e),
        f.clientId && f.Nf && (QD = !0));
        b[N.g.U] && Vn(function() {
            var g = {}
              , k = BD(a);
            k && (g[d] = k);
      ...
      , gE = function(a, b, c) {
        ...
        l(a.h, function(r, t) {
            if (void 0 !== t && !Uh.hasOwnProperty(r)) {
                null === t && (t = "");
                var u;
                r !== N.g.Nc ? u = !1 : a.metadata.euid_mode_enabled ? (d.ecid = t,
                u = !0) : u = void 0;
                if (!u && r !== N.g.We) {
                    var v = t;
                    !0 === t && (v = "1");
                    ...
                    if (aE[r])
                        ...
                        var x;
                        dE[r] ? x = !0 : r !== N.g.Ec ? x = !1 : ("object" !== typeof t && p(r, t),
                        x = !0);
                        x || p(r, t)
                    }
                }
        ...
        l(q, function(r, t) {
            void 0 !== t && ((null === t && (t = ""),
            r !== N.g.Aa || f.uid) ? b[r] !== t && (e[(Fa(t) ? "upn." : "up.") + String(r)] = String(t),
    ...
    var yE = window
      ...
      , AE = function(a) {
        ...
        if (b && b.ioo && b.ioo() || zE.documentElement.hasAttribute("data-google-analytics-opt-out") || a && !0 === yE["ga-disable-" + a])
            return !0;
        try {
            var c = yE.external;
        ...
        for (var d = lm("AMP_TOKEN", String(zE.cookie), !0), e = 0; e < d.length; e++)
            if ("$OPT_OUT" == d[e])
                return !0;
    ...
    aa.lm = function(a) {
        ...
        try {
            if (AE(a.target.da))
                ...
                if (b && Ha(b.destinations))
                    for (var e = 0; e < b.destinations.length; e++)
                        if (AE(b.destinations[e])) {
                            M(125);
                            a.isAborted = !0;
                            break
                        }
            }
            if (0 <= jn.Zk.replace(/\s+/g, "").split(",").indexOf(a.eventName))
                a.isAborted = !0;
            else {
                var f = qD(a);
            ...
            "http:" != g && "https:" != g && (M(29),
            a.isAborted = !0);
            zc && "preview" == zc.loadPurpose && (M(30),
            a.isAborted = !0);
            Q(51) && (a.isAborted = !0);
            Lp(a);
            var k = ji.grl;
            ...
            if (a.metadata.euid_mode_enabled && np(a, "ccd_add_1p_data", !1)) {
                ...
                if (Xi(n)) {
                    var p = U(a.s, N.g.xa);
                    null === p ? a.metadata.user_data_from_code = null : (n.enable_code && od(p) && (a.metadata.user_data_from_code = p),
                    od(n.selectors) && !a.metadata.user_data_from_manual && (a.metadata.user_data_from_manual = Wi(n.selectors)))
                }
            }
            var q = this.Bj, r;
            ...
            B && (this.K = !0);
            a.eventName == N.g.oa && (U(a.s, N.g.Na, !0) ? (a.s.h[N.g.ba] && (a.s.C[N.g.ba] = a.s.h[N.g.ba],
            a.s.h[N.g.ba] = void 0,
            a.h[N.g.ba] = void 0),
            ...
            if (Ga)
                ...
                I.Al(a);
            else if (I.ql() > Ia || a.eventName == N.g.ic)
                ua.jd = !0;
            a.metadata.euid_mode_enabled ? U(a.s, N.g.Aa) ? ua.wc = !0 : (ua.wc && (ua.oe = void 0),
            ua.wc = !1) : ua.wc = !1;
            var Oa = ua.oe;
            if (a.metadata.euid_mode_enabled) {
                ...
                if (void 0 === dd || xc <= dd)
                    a.h[N.g.Nc] = Wa.toString(),
                    a.metadata.enhanced_client_id_source = xc
            }
            O ? (a.copyToHitData(N.g.Ab, ua.sessionId),
            a.copyToHitData(N.g.Od, ua.yc),
            a.copyToHitData(N.g.Nd, ua.jd ? 1 : 0)) : (a.h[N.g.Ab] = ua.sessionId,
            a.h[N.g.Od] = ua.yc,
            a.h[N.g.Nd] = ua.jd ? 1 : 0);
            ...
            if (!U(a.s, N.g.Kb) || !U(a.s, N.g.wb)) {
                ...
                var GG = a.copyToHitData, HG = N.g.Fa, Fi;
                a: {
                    ...
                    if (void 0 !== ji.ga4_referrer_override)
                        Fi = ji.ga4_referrer_override;
                    else {
            ...
            if (!(Q(62) && oD(a) || a.metadata.is_merchant_center || !1 === U(a.s, N.g.rb)) && VB() && S(N.g.I)) {
                ...
                Gi && 0 === (av || 0) && (a.metadata.join_timer_sec = 60,
            ...
            if (void 0 !== U(a.s, N.g.Jd))
                a.copyToHitData(N.g.Jd);
            else {
                var ev = U(a.s, N.g.Ld), Am, Hi;
                a: {
                    if (QD) {
                        var Bm = ND(a) || {};
                        if (Bm && Bm[N.g.U])
                            for (var fv = rn(tn(a.h[N.g.Fa]), "host", !0), Ii = Bm[N.g.U], Dg = 0; Dg < Ii.length; Dg++)
                                if (Ii[Dg]instanceof RegExp) {
                                    if (Ii[Dg].test(fv)) {
                                        Hi = !0;
                                        break a
                                    }
                ...
                if (!(Am = Hi)) {
                    ...
                    if (Ji = ev)
                        a: {
                            for (var gv = ev.include_conditions || [], OG = rn(tn(a.h[N.g.Fa]), "host", !0), Cm = 0; Cm < gv.length; Cm++)
                                if (gv[Cm].test(OG)) {
                                    Ji = !0;
                                    break a
                                }
            ...
            oD(a) && Fj() && (Gj() && rD(a, "gcd", fm(a.s)),
            U(a.s, N.g.qa) && rD(a, "adr", 1));
            if (oD(a)) {
                var jv = br();
            ...
            a: if (Q(7))
                if (!en(z))
                    ...
                    if (nv) {
                        if (Q(25)) {
                            if (U(a.s, N.g.Sc) && !oD(a))
                                break a
                        } else if (U(a.s, N.g.Sc))
                            break a;
                        ln(nv, a)
                    } else
                        M(86)
            ...
            if (Q(36)) {
                var Dm = Kq(Jq());
                Dm || ME || (ME = !0,
                vl(''),
                Dm = Kq(Jq()));
                Dm && (a.h[N.g.Ib] = "1")
            }
            ...
            var QG = this.Bj, tv, RG = this.h, Gm;
            a: {
                var Hm = MD(a);
                if (Hm) {
                    if (KD(Hm, a)) {
            ...
            if (oD(a)) {
                ...
                if ("page_view" === a.eventName || TG)
                    EE(this, a, N.g.I),
                    Q(73) && EE(this, a, N.g.O)
            }
            this.D.Ih();
            this.be = NE(a, this.be);
            a.copyToHitData(N.g.og);
            U(a.s, N.g.Sc) && (a.h[N.g.Sc] = !0,
            Q(33) && oD(a) || DE(a, N.g.zb));
            if (a.isAborted) {
                a.s.onFailure();
                wb();
                return
    ...
    ;var OE = function(a) {
        if (Q(67) && "prerendering"in H ? H.prerendering : "prerender" === H.visibilityState)
            return !1;
        a();
        return !0
    }
      , PE = function(a) {
        if (!OE(a)) {
            var b = !1
              , c = function() {
                !b && OE(a) && (b = !0,
                Lc(H, "visibilitychange", c),
                Q(67) && Lc(H, "prerenderingchange", c),
                M(55))
            };
    ...
    function JF(a, b, c) {
        ...
        e[d[f]].sort(function(n, p) {
            if (void 0 === n[k] || void 0 === p[k])
                throw Error("sortRemoteConfigParameters failed, object does not have required property: " + k);
    ...
    (function(a) {
        ...
        if (vi)
            ...
            var f = function(u) {
                ...
                Gc("https://" + ii.Pe + "/debug/bootstrap?id=" + Pf.ctid + "&src=" + w + "&cond=" + u + "&gtm=" + Um()));
                var y = {
            ...
            if (Yj().canonical[b]) {
                ...
                for (var p = d.rules || [], q = 0; q < p.length; q++) {
                    for (var r = p[q], t = {}, u = 0; u < r.length; u++) {
                        ...
                        hf(5) || hf(7) ? ("if" !== v && "unless" !== v || uf(t[v]),
                        vb("TAGGING", 22)) : hf(6) && vb("TAGGING", 23)
                    }
                    lf.push(t)
                }
                pf = Z;
                ...
                vH();
                if (Q(46)) {
                    for (var T = ej["7"], ba = T ? T.split("|") : [], ja = {}, ha = 0; ha < ba.length; ha++)
                        ja[ba[ha]] = !0;
